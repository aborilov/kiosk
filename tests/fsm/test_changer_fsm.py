...
class TestChangerFsm(TestCase):
    ...
    def setUp(self):
        ...
        self.changer = MagicMock(name='changer')
        self.changer.start_accept = MagicMock(name='start_accept')
        self.changer.stop_accept = MagicMock(name='stop_accept')
        self.changer.dispense_amount = MagicMock(name='dispense_amount')
    ...
    # inputs
    # fsm.state("OFF",         DA   DA   DA   DA   DA   DA   DA   DA   DA   DA   DA   DA   DA   DA   DA   DA   DA   DA
    #          "ON",
    #          "ERR",
    #          "RDY",
    #          "WC",
